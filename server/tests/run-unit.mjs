...
const unitFiles = [
  ...
  './unit/decision-arbiter.test.mjs',
  './unit/pattern-signal-engine.test.mjs',
  './unit/deterministic-entry-policy.test.mjs',
  './unit/heuristic-entry-policy.test.mjs',
  './unit/position-exit-policy.test.mjs',
